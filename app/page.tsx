...
              <input name="pickup_address" required className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Pickup address" />
              <input name="dropoff_address" required className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Drop-off address" />

              <div className="grid gap-4 sm:grid-cols-2">
                <input name="date" required className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Date" />
                <input name="time" required className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Time" />
              </div>

              <div className="grid gap-4 sm:grid-cols-2">
                <select name="passengers" className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none">
...
                <select name="service_type" className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none">
...
              <input name="customer_name" required className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Your name" />
              <input name="phone_number" required className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Phone number" />
              <input name="email" type="email" className="rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Email optional" />
              <textarea name="notes" className="min-h-24 rounded-xl border border-white/10 bg-white p-4 text-slate-950 outline-none" placeholder="Flight number, luggage, or special request" />
...
                Request goes directly to H&T Transportation.
              </p>
            </div>
          </form>
        </div>
...
                <a href="#contact" className="mt-6 inline-block font-black text-blue-700">Request service →</a>
              </div>
            ))}
          </div>
        </div>
...
            <h2 className="mt-4 text-4xl font-black md:text-5xl">Local Service. Professional Standards.</h2>
...
            <p className="mt-4 text-sm text-slate-400">Call, text, or request a quote online.</p>
